...
export default function RecensioneTutor() {
  ...
  async function inviaRecensione() {
    ...
    else { setSuccess(true); setTimeout(() => router.push('/tutor'), 1500) }
    setLoading(false)
  }
  ...
  return (
    <Layout>
      <div style={{ maxWidth: 600, margin: '0 auto', padding: '40px 32px' }}>
        ...
        <p style={{ fontSize: 14, color: '#6B7280', marginBottom: 32 }}>Aiuta altri studenti a scegliere il tutor giusto</p>
