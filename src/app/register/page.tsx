  ...
  return (
    <div style={{ minHeight: '100vh', background: '#ffffff', display: 'flex', flexDirection: 'column', fontFamily: 'var(--font-geist-sans, system-ui)' }}>
      <nav style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '0 36px', height: 56, borderBottom: '0.5px solid #F4F4F5' }}>
        ...
        <Link href="/login" style={{ fontSize: 13, color: '#71717A', textDecoration: 'none' }}>
          Hai già un account? <span style={{ color: '#18181B', fontWeight: 500 }}>Accedi</span>
        </Link>
      </nav>

      <div style={{ flex: 1, display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '40px 32px' }}>
        <div style={{ width: '100%', maxWidth: 400 }}>
          <h1 style={{ fontSize: 26, fontWeight: 500, color: '#18181B', margin: '0 0 6px', letterSpacing: -0.5 }}>Crea il tuo account</h1>
          <p style={{ fontSize: 13, color: '#71717A', margin: '0 0 28px' }}>Unisciti a migliaia di studenti su klass.</p>
          ...
          {success && (
            <div style={{ background: '#F0FDF4', border: '0.5px solid #BBF7D0', borderRadius: 8, padding: '10px 14px', marginBottom: 16 }}>
              <p style={{ fontSize: 13, color: '#15803D', margin: 0 }}>Account creato! Benvenuto su klass.</p>
            </div>
          )}
          ...
          <div style={{ marginBottom: 14 }}>
            <label style={{ fontSize: 12, fontWeight: 500, color: '#18181B', display: 'block', marginBottom: 6 }}>Il tuo nome</label>
            <input
              type="text"
              placeholder="Marco"
              value={nome}
          ...
          <p style={{ fontSize: 12, color: '#A1A1AA', textAlign: 'center', marginTop: 16 }}>
            Registrandoti accetti i nostri{' '}
            <Link href="/termini" style={{ color: '#71717A', textDecoration: 'none' }}>Termini e condizioni</Link>
          </p>
        </div>
      </div>
    </div>
